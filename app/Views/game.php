...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('/css/rubik.css') ?>">
...
<body>
  ...
  <script defer src="<?= base_url('/js/rubik.js') ?>"></script>
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      console.log("DOM fully loaded"); // Pastikan ini muncul di console

      const gameContainer = document.querySelector('.ui__game');
      gameContainer.style.pointerEvents = 'auto';

      gameContainer.addEventListener('click', function(e) {
        console.log("Click detected at:", e.clientX, e.clientY); // Verifikasi click
        // Kode game Anda di sini
      }, false);
    });
  </script>
